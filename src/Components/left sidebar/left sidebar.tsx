...
const LeftSideBar: React.FC<LeftSideBarProps> = ({ Language }) => {
  const ImgLink: React.FC<{ img1: string; img2: string; url: string }> = ({ img1, img2, url }) => {
    return (
  ...
  return (
    <div className={styles.box}>
      <ImgLink img1={linkedinIcon} img2={linkedinIconRosa} url={urlLinkedin}></ImgLink>
      <ImgLink img1={githubIcon} img2={githubIconRosa} url={urlGithub}></ImgLink>
      <ImgLink
        img1={pdfIcon}
        img2={pdfIconRosa}
